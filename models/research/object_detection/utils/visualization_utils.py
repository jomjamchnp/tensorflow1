...
#       xmin = int(xmin*width)
#       xmax = int(xmax*width)
#       box_to_score_map[box] = box_to_score_map[box] * 100
#       coordinates_list.append([ymin, ymax, xmin, xmax, (box_to_score_map[box]), int(class_name)])
...
def return_coordinates(
  ...
  for box, color in box_to_color_map.items():
      ...
      xmax = int(xmax*width)
      box_to_score_map[box] = box_to_score_map[box]*100
      coordinates_list.append([ymin, ymax, xmin, xmax,box_to_score_map[box] , box_to_display_str_map[box]])
      counter_for = counter_for + 1  
